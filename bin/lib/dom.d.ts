...
export declare type PointerEventCallback = (event: PointerEvent) => void;
export declare const pointer: (element: Element, onPointerDown: PointerEventCallback, onPointerMove: PointerEventCallback, onPointerUp: PointerEventCallback) => void;
